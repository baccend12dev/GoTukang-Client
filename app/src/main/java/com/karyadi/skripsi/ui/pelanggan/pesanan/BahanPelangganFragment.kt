...
import com.karyadi.skripsi.databinding.FragmentBahanPelangganBinding
...
//                getActivity()?.startActivity(move)
    ...
    private fun popupKirimData(context: Context?, data: DetailKategoriNilai) {
        ...
        materialAlertDialogBuilder.setTitle("Kirim Data")
            .setMessage("Apa Anda sudah yakin ingin melakukan tukang ini?")
    ...
    private fun kirimData(data: DetailKategoriNilai) {
        ...
        when (binding.rgStatusBahan.checkedRadioButtonId) {
            R.id.rb_status_bahan_1 -> value = "Diantar ke lokasi tukang"
            R.id.rb_status_bahan_2 -> value = "Diambil oleh tukang"
        }
